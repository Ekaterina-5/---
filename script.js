...
function reset() {
    location.reload();
    document.getElenentById("b1").value = '';
    document.getElenentById("b2").value = '';
    document.getElenentById("b3").value = '';
    document.getElenentById("b4").value = '';
    document.getElenentById("b5").value = '';
    document.getElenentById("b6").value = '';
    document.getElenentById("b7").value = '';
    document.getElenentById("b8").value = '';
    document.getElenentById("b9").value = '';
}
